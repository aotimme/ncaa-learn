...
func main() {
	// e.g.
	// "../data/kaggle/2017-rankings.csv"
	// "../data/2014_rankings.csv"
	var resultsFile string
	flag.StringVar(&resultsFile, "results", "", "Results file (output of `go run learn.go`)")
	flag.Parse()

	err := ReadRankings(resultsFile)
	if err != nil {
		panic(err)
	}
